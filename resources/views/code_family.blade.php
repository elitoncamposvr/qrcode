                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="w-full pb-1.5 flex flex-col">
                        <div class="w-full pb-1.5 inline-flex justify-end">
                            <x-link-btn :href="route('codefamily.create')">{{ __('Nova Família') }}</x-link-btn>
                        </div>
                        ...
                        @foreach($codefamily as $code)
                            <div class="w-full inline-flex border-b my-4 dark:border-b-gray-700">
                                ...
                                <div class="w-1/6 flex items-center justify-evenly">
                                    <a href="{{ route('codefamily.edit', [$code->id]) }}">
                                    ...
                                    <form method="post" action="{{ route('codefamily.destroy') }}">
                                        @csrf
                                        @method('delete')
